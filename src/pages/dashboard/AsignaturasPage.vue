...
import EstudianteAsignaturas from '@/components/asignaturas/EstudianteAsignaturas.vue'
import AdminAsignaturas from '@/components/asignaturas/AdminAsignaturas.vue'
